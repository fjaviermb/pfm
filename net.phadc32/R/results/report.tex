...
\hypersetup{unicode=true,
            pdftitle={Anomlay detector based on PHAD-C32 (1999) {[}TFM{]}},
            pdfauthor={Francisco Javier Motos Barragán},
            pdfborder={0 0 0},
            breaklinks=true}
...
\setlength{\droptitle}{-2em}
  ...
  \title{Anomlay detector based on PHAD-C32 (1999) {[}TFM{]}}
...
\includegraphics{report_files/figure-latex/Load Report Data-1.pdf}
...
\includegraphics{report_files/figure-latex/unnamed-chunk-2-8.pdf}
...
\includegraphics{report_files/figure-latex/unnamed-chunk-3-5.pdf}
\includegraphics{report_files/figure-latex/unnamed-chunk-3-6.pdf}
